  ...
  <header class="app-header navbar">
    ...
    <a class="navbar-brand" href="<?php echo ROUTES['app']['Home'] ?>">
      <img class="navbar-brand-full" src="<?php echo media(); ?>img/software-cobranzas.png" width="95" alt="logo">
      <img class="navbar-brand-minimized" src="<?php echo media(); ?>img/software-cobranzas.png" width="30" alt="logo">
    </a>
