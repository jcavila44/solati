          ...
          <div class="card p-4">
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                ...
                <input id="correo" name="correo" class="form-control" type="text" placeholder="Correo" value="test@test.com">
              </div>
              <div class="input-group mb-4">
                ...
                <input id="password" name="password" class="form-control" type="password" placeholder="Contraseña" value="admin123">
              </div>
              <div class="row">
                <div class="col-6">
